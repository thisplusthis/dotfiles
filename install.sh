...
echo -e "\n${BLUE}Optional: Install Harlequin SQL IDE${NC}"
echo -e "  Run: ${BLUE}$DOTFILES_DIR/install-harlequin.sh${NC}"
echo -e "  See: ${BLUE}./TOOLS.md#sql-ide-harlequin${NC} for setup details\n"
