...
return require('packer').startup(function(use)
        ...
        -- add fancy text object functionality to treesitter (dic - delete inner class, doc - delete outer class)
        use {
        ...
        -- Telescope file browser / live_grep (use <leader>ff and <leader>fq)
        -- Note: to use live_grep out of the box, install ripgrep -- `brew install ripgrep` 
        use {
        ...
        -- open new terminal with <leader>t
        use { "akinsho/toggleterm.nvim", tag = '*', config = [[require('config.toggleterm')]] }

        -- SCNvim - SuperCollider support for Neovim
        use { 'davidgranstrom/scnvim', config = [[require('config.scnvim')]] }
