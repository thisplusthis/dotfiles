" Name:         cubensis
" Author:       James McDonald (hacked from Elflord theme)

set background=dark

hi clear
let g:colors_name = 'cubensis'
...
" hi Normal guifg=#00ffff guibg=#111c21 gui=NONE cterm=NONE
hi Normal guifg=#8f9fb0 guibg=#13141a gui=NONE cterm=NONE
hi QuickFixLine guifg=#ffffff guibg=#2e8b57 gui=NONE cterm=NONE
hi ColorColumn guifg=#000000 guibg=#7c348c gui=NONE cterm=NONE
hi CursorColumn guifg=NONE guibg=#3a3a3a gui=NONE cterm=NONE
hi CursorLine guifg=NONE guibg=#131726 gui=NONE cterm=NONE
hi CursorLineNr guifg=#859418 guibg=NONE gui=bold cterm=bold
hi Folded guifg=#656070 guibg=#10121a gui=NONE cterm=NONE
hi Conceal guifg=#666666 guibg=NONE gui=NONE cterm=NONE
hi Cursor guifg=#000000 guibg=#00ffff gui=NONE cterm=NONE
hi Directory guifg=#3fc9e8 guibg=NONE gui=NONE cterm=NONE
hi EndOfBuffer guifg=#cccccc guibg=NONE gui=bold cterm=NONE
...
hi LineNr guifg=#545a5e guibg=NONE gui=NONE cterm=NONE
...
hi NonText guifg=#13171f guibg=NONE gui=bold cterm=bold
hi Pmenu guifg=#ffffff guibg=#2b303d gui=NONE cterm=NONE
...
hi SignColumn guifg=#5e7080 guibg=NONE gui=NONE cterm=NONE
...
hi String guifg=#2fcf17 guibg=NONE gui=NONE cterm=NONE
...
hi Terminal guifg=#00ffff guibg=#5e7080 gui=NONE cterm=NONE
hi Title guifg=#ff00ff guibg=NONE gui=bold cterm=bold
hi VertSplit guifg=#000000 guibg=#5e7080 gui=NONE cterm=NONE
...
hi Boolean guifg=#cc71e3 guibg=NONE gui=NONE cterm=NONE
hi Character guifg=#ff0000 guibg=NONE gui=NONE cterm=NONE
" hi Comment guifg=#de8a14 guibg=NONE gui=NONE cterm=NONE    " orange comments
hi Comment guifg=#93a6cc guibg=#2a303b gui=italic cterm=italic
hi Constant guifg=#d197e8 guibg=NONE gui=NONE cterm=NONE     " strings
hi Error guifg=#ffffff guibg=#ff0000 gui=NONE cterm=NONE
hi Function guifg=#3fc9e8 guibg=NONE gui=NONE cterm=NONE     " supercollider .wait, def func
hi Identifier guifg=#cbcfd1 guibg=NONE gui=NONE cterm=NONE   " var s, e,  (majority of text)
hi Ignore guifg=#000000 guibg=#000000 gui=NONE cterm=NONE
hi Label guifg=#217effa guibg=NONE gui=NONE cterm=NONE
hi Operator guifg=#d6115d guibg=NONE gui=NONE cterm=NONE
hi PreProc guifg=#c175fa guibg=NONE gui=NONE cterm=NONE    " python imports
hi Repeat guifg=#32affc guibg=NONE gui=NONE cterm=NONE
hi Special guifg=#c281eb guibg=NONE gui=NONE cterm=NONE    " supercollider (, ]), chars etc.
hi Statement guifg=#a0b325 guibg=NONE gui=bold cterm=bold  " supercollider arg
hi Todo guifg=#000000 guibg=#f02ed9 gui=NONE cterm=NONE
hi Type guifg=#ff059f guibg=NONE gui=NONE cterm=NONE    " supercollider class
...
if s:t_Co >= 256
  ...
  hi Cursor ctermfg=16 ctermbg=45 cterm=NONE
  ...
  hi LineNr ctermfg=148 ctermbg=NONE cterm=NONE
  ...
  hi PmenuSel ctermfg=16 ctermbg=45 cterm=NONE
  ...
  hi StatusLine ctermfg=16 ctermbg=45 cterm=bold
  hi StatusLineNC ctermfg=16 ctermbg=45 cterm=NONE
  ...
  hi VertSplit ctermfg=16 ctermbg=45 cterm=NONE
